    ...
    internal class Program
    {
        ...
        static void testFindCountry_ByID(int ID)
        {
            ...
            if (country != null)
            {
                ...
                Console.WriteLine("Country PhoneCode : " + country.PhoneCode);
            }
            else
        ...
        static void testAddNewCountry()
        {
            ...
            country1.Code = "FRA";
            country1.PhoneCode = "33";


            if (country1.Save())
                Console.WriteLine($"New Country: \"{country1.CountryName}\" Added Successfully.");
            else
                Console.WriteLine($"New Country: \"{country1.CountryName}\" Adding Failed!!");
        }
